  ...
  return (
    <div className="space-y-6 netra-fade-in">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
                ...
                {days.map((day) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        'bg-card min-h-[76px] p-2 text-left transition-all hover:bg-accent/40',
                        !inMonth && 'opacity-30',
                        selected && 'bg-primary/8 dark:bg-primary/10 ring-1 ring-inset ring-primary/50'
                      )}
                    >
                      <span className={cn(
        ...
        {/* Day detail panel */}
        <div>
          <div className="netra-card h-full p-5">
            {selectedDay ? (
              <>
                ...
                {selectedPosts.length === 0 ? (
                  <div className="text-center py-10">
                    ...
                    <Link href="/create">
                      <Button size="sm" variant="outline" className="mt-3 text-xs font-semibold">+ Create Post</Button>
                    </Link>
                  </div>
                ) : (
                  <div className="flex flex-col gap-2">
                    {selectedPosts.map((post) => (
                      <div key={post.id} className="p-3 rounded-xl border border-border bg-surface/50 hover:bg-surface transition-colors">
